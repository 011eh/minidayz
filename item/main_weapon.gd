...
const RES_TABLE := {
	0: preload('res://item/res/ranged_weapon/improvised_bow.tres'),
	1: preload('res://item/res/ranged_weapon/crossbow.tres'),
	2: preload('res://item/res/ranged_weapon/ak-74.tres'),
	3: preload('res://item/res/ranged_weapon/akm.tres'),
	4: preload('res://item/res/ranged_weapon/aks74u.tres'),
	5: preload('res://item/res/ranged_weapon/aug.tres'),
	6: preload('res://item/res/ranged_weapon/bizon.tres'),
	7: preload('res://item/res/ranged_weapon/izh-43.tres'),
	8: preload('res://item/res/ranged_weapon/fn_cal.tres'),
	9: preload('res://item/res/ranged_weapon/groza.tres'),
